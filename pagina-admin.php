  ...
  <div class="container">
    <div class="dashboard-box p-4 rounded text-white">
      ...
      <div class="d-flex gap-3 mb-4 flex-wrap">
        <div class="badge bg-dark p-2">Este mês</div>
        <div class="badge bg-dark p-2 d-flex align-items-center">
          Denúncias pendentes <span class="badge bg-secondary ms-2">3</span>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6 mb-4">
          <div class="box-yellow p-4 rounded">
            ...
            <div class="bar-graph d-flex align-items-end gap-2">
        ...
        <div class="col-md-6">
          <div class="box-yellow p-3 rounded mb-3">
            ...
            <div class="circle-placeholder mx-auto my-3"></div>
          </div>
